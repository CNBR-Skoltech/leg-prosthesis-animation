...
#     man = stl_to_triangles('model/foot.stl')
#     translation = np.array([-200, 0, 0])
#     man.pos = vec(-200, 0, 0)
#     man.color = color.cyan
#     pos0 = np.array([man.size.x, man.size.y, man.size.z]).T
#     p = np.array([1, man.axis.y, man.axis.z])
#     s = [man.size.hat.x, man.size.hat.y, man.size.hat.z]
#     while True:
#         rate(100)
#         p = rotMat @ p
#         # p[p == 0] = 1
#         man.rotate(angle=0.1, axis=vec(1, 0, 0), origin=vec(100, 10, 10))
#         # man.axis.x = pos[0]
#         # man.axis.y = pos[1]
#         # man.axis.z = pos[2]
